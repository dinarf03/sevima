...
<body>
        ...
        <div class="container-login100" style="background-image: url('vendor/login/images/bg-01.jpg');">
          <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <form class="login100-form validate-form" action="" method="post">
              <span class="login100-form-title p-b-49">E-LEARNING LOGIN</span>
              <div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
                <span class="focus-input100" data-symbol="&#xf206;"></span>
              </div>
              <div class="wrap-input100 validate-input m-b-23" data-validate="Password is required">
                <span for="Password" class="label-input100">Password</span>
                <input type="input100" type="password" name="password" placeholder="Type your password">
                <span class="focus-input100" data-symbol="&#xf190;"></span>
              </div>
              <div class="wrap-input100 validate-input" data-validate="Password is required">
                <span class="label-input100">User</span>
                <select class="form-control" name="level" required style="background-color: #212121;border-radius: 7px;color: #fff;font-weight: bold;">
              ...
              <div class="text-right p-t-8 p-b-31">
                <a href="https://wa.me/628226599944">
                  Forgot password?
                </a>
              </div>
              <div class="container-login100-form-btn m-b-23">
                <div class="wrap-login100-form-btn">
                  ...
                  <button value="LOGIN" type="submit" name="Login" class="login100-form-btn">
                    Login
                  </button>
                </div>
              </div>
    ...
    <script src="endor/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
