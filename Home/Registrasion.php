...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="limiter">
      <div class="class="container-login100" style="background-image: url('../vendor/login/images/bg-01.jpg');"">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
          ...
          <form action="" method="post" class="login100-form validate-form">
            ...
            <div class="wrap-input100 validate-input data-validate="jurusan is required"">
  						<span for="kelas" class="label-input100">Pilih Jurusan</span>
                ...
                <?php
                $sqlKelas=mysqli_query($con, "SELECT * FROM tb_master_jurusan ORDER BY id_jurusan DESC");
                while($kelas=mysqli_fetch_array($sqlJurusan)){
