...
<div class="content-wrapper">
  ...
  <div class="row">
    ...
    <div class="col-md-3" style="overflow:scroll;height:600px;border-radius:7px;background-color:white">
      ...
      <div class="mt-3">
        <!-- info daftar guru  -->
        <?php $sqlg = mysqli_query($con, "SELECT * FROM tb_guru WHERE status='N' ORDER BY id_guru DESC");?>
        <?php foreach ($sqlg as $d) {?>
          <?php
if ($d['confirm'] == 'Yes') {
    #code...
} else {
                  ...
                  <table class="table">
                    <tr>
                      <td colspan="3" align="center">
                        <img src="../vendor/images/img_Guru/logo1.jpg" class="img-thumbnail" style="width:60px;height:60px;">
                      </td>
                    </tr>
                    <tr>
                      <td>Nip/Nuptk</td>
