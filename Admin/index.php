      ...
      <div class="container-fluid page-body-wrapper">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#masterData" aria-expanded="false" aria-controls="general-pages">
                ...
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="?page=jurusan" style="color:#fff;">
                      <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="?page=semester" style="color:#fff;">
                      <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;
                      <span class="menu-title">Master Semester</span>
                    </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="?page=jenisujian" style="color:#fff;">
                      <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;
                      <span class="menu-title">Master Jenis Ujian</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?page=jenisperangkat" style="color:#fff;">
                      <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;
                      <span class="menu-title">Master Jenis Perangkat</span>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#evaluasi" aria-expanded="false" aria-controls="general-pages">
                <i class="fa fa-spin fa-gear icon-md"style="font-size:20px;"></i> &nbsp;
                <span class="menu-title"> USER MANAGE </span><i class="menu-arrow"></i>
              </a>
                ...
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="?page=siswa" style="color:#fff;">
                      <i class="fa fa-user-circle-o" style="font-size:20px;color:#fff;"></i> &nbsp;&nbsp;
            ...
            <li class="nav-item">
              <a class="nav-link" href="?page=setting">
                <i class="fa fa-gears" style="font-size:20px;"></i> &nbsp;&nbsp;
                <span class="menu-title">SET APLIKASI</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="?page=setting&act=user">
                <i class="fa fa-user" style="font-size:20px;"></i> &nbsp;&nbsp;
                <span class="menu-title">SET PROFILE</span>
              </a>
            </li>
            <hr>
    ...
    ?>
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> <?php echo $apl['nama_sekolah']; ?>
